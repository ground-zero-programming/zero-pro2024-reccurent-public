...
<html lang="en" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>Content with notebooks &#8212; 広島大学 2023年度 社会人向けリカレント教育WEB講座 はじめてのデータ分析</title>
...
<a class="navbar-brand logo" href="../../../../../../intro.html">
    ...
    <img src="../../../../../../_static/logo_dalle3.png" class="logo__image only-light" alt="広島大学 2023年度 社会人向けリカレント教育WEB講座 はじめてのデータ分析 - Home"/>
    <img src="../../../../../../_static/logo_dalle3.png" class="logo__image only-dark pst-js-only" alt="広島大学 2023年度 社会人向けリカレント教育WEB講座 はじめてのデータ分析 - Home"/>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/01_intro/introduction_and_setup.html">イントロダクションとGoogle Colaboratoryの導入</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/01_lecture/variables_and_data_types.html">変数とデータ型（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/01_exercise/exercise_variables_and_data_types.html">変数とデータ型（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/02_lecture/conditional_branch.html">条件分岐（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/02_exercise/exercise_conditional_branch.html">条件分岐（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/03_lecture/loops.html">繰り返し処理（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/03_exercise/exercise_loops.html">繰り返し処理（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/04_lecture/functions_and_scope.html">関数（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/04_exercise/exercise_functions_and_scope.html">関数（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/05_lecture/introduction_to_data_analysis.html">データ分析入門（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/05_exercise/exercise_introduction_to_data_analysis.html">データ分析入門（演習）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/06_lecture/introduction_to_machine_learning.html">機械学習入門（講義）</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/06_exercise/exercise_introduction_to_machine_learning.html">機械学習入門（演習）</a></li>
</ul>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/00_check_environment.html">ローカル環境でのPythonの動作確認</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../../docs/anaconda_python/anaconda_python.html">AnacondaによるPythonファイルの実行</a></li>
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://colab.research.google.com/github/ground-zero-programming/zero-pro2023-reccurent-public/blob/main/.venv/lib/python3.11/site-packages/jupyter_book/book_template/notebooks.ipynb" target="_blank"
...
<div class="dropdown dropdown-source-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://github.com/ground-zero-programming/zero-pro2023-reccurent-public" target="_blank"
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/ground-zero-programming/zero-pro2023-reccurent-public/issues/new?title=Issue%20on%20page%20%2F.venv/lib/python3.11/site-packages/jupyter_book/book_template/notebooks.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="output text_plain highlight-myst-ansi notranslate"><div class="highlight"><pre><span></span>&lt;contextlib.ExitStack at 0x106369150&gt;
</pre></div>
</div>
</div>
</div>
